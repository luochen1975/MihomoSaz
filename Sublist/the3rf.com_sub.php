...
proxy-providers:
  ...
  proxy:
    type: http
    url: >-
      https://url.v1.mk/sub?&url=https://free.pcwwrk.workers.dev/output.txt?url=https%253A%252F%252Fthe3rf.com%252Fsub.php&outputFormat=base64&totalCount=500&protocols=%255B%257B%2522protocol%2522%253A%2522vless%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522vmess%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522trojan%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522ss%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522hysteria2%252Chy2%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522tuic%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522ssr%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522juicity%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522hysteria%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522snell%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522mieru%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522anytls%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522wireguard%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522ssh%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522warp%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522socks5%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522socks4%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522http%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522https%2527s%2522%252C%2522count%2522%253A0%257D%252C%257B%2522protocol%2522%253A%2522mtproto%2522%252C%2522count%2522%253A0%257D%255D&cloudflareOnly=false&target=clash&config=https%3A%2F%2Fcdn.jsdelivr.net%2Fgh%2FSleepyHeeead%2Fsubconverter-config%40master%2Fremote-config%2Funiversal%2Furltest.ini&emoji=false&append_type=true&append_info=true&scv=true&udp=true&list=true&sort=false&fdn=true&insert=false
    interval: 86400
    include-all: true
    path: ./MihomoSaz149.yaml
    health-check:
      enable: true
      interval: 1800
      url: "https://www.gstatic.com/generate_204"
